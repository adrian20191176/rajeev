// Royal Crown Bearings — domain data
...
export type Brand = { name: string; country: string };
...
export const CATEGORIES: Category[] = [
  {
    ...
    short: 'Versatile workhorse — radial loads, modest thrust.',
    description: 'Deep groove ball bearings are the most widely used bearing type, suitable for high speeds, radial loads, and limited axial loads in both directions. Sealed, shielded and open variants are available across miniature to heavy-duty bores.',
    iconType: 'groove',
    image: 'https://www.wychbearings.co.uk/user/products/large/bearing_2rs%20FAG.png',
  },
  {
    slug: 'miniature-ball',
    name: 'Miniature & Extra Small Ball Bearings',
    family: 'Ball Bearings',
    short: 'Precision micro bearings for compact assemblies.',
    description: 'Miniature and extra small ball bearings serve dental drills, model assemblies, instruments and small motors where precision rotation is critical. Stocked in shielded, sealed and open formats.',
    iconType: 'mini',
  },
  {
    ...
    family: 'Ball Bearings',
    short: 'Combined radial + axial loads in one direction.',
    description: 'Angular contact ball bearings carry combined radial and axial loads in a single direction. Ideal for spindles, pumps, and high-speed machine tool applications. Single, paired and matched-set arrangements available.',
    iconType: 'angular',
  },
  {
    slug: 'self-aligning',
    ...
    family: 'Ball Bearings',
    short: 'Tolerates shaft misalignment, deflection.',
    description: 'Self-aligning ball bearings handle shaft misalignment and shaft deflection due to their two rows of balls running on a common spherical raceway. Common in conveyors, agricultural equipment, and textile machinery.',
    iconType: 'selfalign',
  },
  {
    slug: 'cylindrical-roller',
    name: 'Cylindrical Roller Bearings',
    family: 'Roller Bearings',
    short: 'Heavy radial loads, high speeds.',
    description: 'Cylindrical roller bearings carry very heavy radial loads at high speeds. Line contact between rollers and raceways gives them rigidity and durability for gearboxes, electric motors and rolling mills.',
    iconType: 'cylindrical',
  },
  {
    slug: 'needle-roller',
    name: 'Needle Roller Bearings',
    family: 'Roller Bearings',
    short: 'Compact section, very high load capacity.',
    description: 'Needle roller bearings have a small radial section but very high load-carrying capacity, making them ideal where space is limited — automotive transmissions, universal joints, pumps and compressors.',
    iconType: 'needle',
  },
  {
    slug: 'tapered-roller',
    ...
    family: 'Roller Bearings',
    short: 'Combined heavy radial + thrust loads.',
    description: 'Tapered roller bearings handle simultaneous heavy radial and axial loads. Widely used in vehicle wheel hubs, axle assemblies, gearboxes, and heavy-duty industrial equipment.',
    iconType: 'tapered',
  },
  {
    ...
    family: 'Roller Bearings',
    short: 'Self-aligning, very heavy radial loads.',
    description: 'Spherical roller bearings deliver self-aligning capability with very high load ratings, perfect for heavy industry — crushers, mining equipment, fans, vibrating screens and paper machinery.',
    iconType: 'spherical',
  },
  {
    slug: 'thrust',
    ...
    family: 'Thrust',
    short: 'Pure axial loads, single or double direction.',
    description: 'Thrust bearings are designed for purely axial loading. Ball, cylindrical and tapered varieties cover everything from steering knuckles to crane hooks and turntables.',
    iconType: 'thrust',
  },
  {
    slug: 'v-belts-classic',
    name: 'V-Belts: A, B, C, D',
    family: 'Belts',
    short: 'Classic-section industrial V-belts.',
    description: 'Classical V-belts in A, B, C and D sections for general-purpose power transmission across fans, compressors, pumps and machinery drives. Stocked in a wide range of lengths.',
    iconType: 'vbelt',
  },
  {
    slug: 'v-belts-narrow',
    name: 'V-Belts: SPA, SPB, SPC',
    family: 'Belts',
    short: 'Narrow-section, higher power density.',
    description: 'Narrow-section wedge V-belts (SPA, SPB, SPC) deliver higher power capacity in a smaller drive footprint compared to classical sections. Ideal for compact, high-output drives.',
    iconType: 'vbelt',
  },
  {
    slug: 'v-belts-raw-edge',
    name: 'V-Belts: XPA, XPB, XPC',
    family: 'Belts',
    short: 'Raw-edge cogged narrow wedge belts.',
    description: 'XPA, XPB and XPC raw-edge cogged wedge belts run cooler at high speeds and over small pulleys, extending service life on demanding industrial drives.',
    iconType: 'vbelt',
  },
  {
    slug: 'tooth-belts-lh',
    name: 'Tooth Belts: L, H',
    family: 'Belts',
    short: 'Imperial-pitch synchronous belts.',
    description: 'Classical L and H pitch synchronous (timing) belts for positive, slip-free power transmission in conveyors, packaging machinery and light industrial drives.',
    iconType: 'tooth',
  },
  {
    slug: 'tooth-belts-htd',
    name: 'Tooth Belts: 3M, 5M, 8M',
    family: 'Belts',
    short: 'HTD curvilinear-tooth synchronous belts.',
    description: 'HTD-profile (3M, 5M, 8M) synchronous belts feature a curvilinear tooth shape for higher load capacity and smoother engagement than classical timing belts.',
    iconType: 'tooth',
  },
  {
    slug: 'tooth-belts-t',
    name: 'Tooth Belts: T5, T10',
    family: 'Belts',
    short: 'Metric-pitch trapezoidal timing belts.',
    description: 'T5 and T10 metric-pitch timing belts offer precise positioning for linear actuators, automation, machine-tool axes and packaging equipment.',
    iconType: 'tooth',
  },
  {
    slug: 'oil-seals',
    name: 'Oil Seals',
    family: 'Seals',
    short: 'Rotary shaft seals — keep lubricant in, contaminants out.',
    description: 'Oil seals (rotary shaft seals) prevent lubricant leakage and exclude dirt, dust and water from rotating shaft assemblies. Single lip, double lip and metric/imperial sizes stocked.',
    iconType: 'seal',
  },
  {
    slug: 'housings',
    name: 'Housings: UCP, UCF, UCFC, UCT',
    family: 'Housings',
    short: 'Pillow blocks, flange and take-up units.',
    description: 'Cast-iron bearing housings — UCP pillow blocks, UCF four-bolt flanges, UCFC piloted flanges and UCT take-up units — for ready-to-mount shaft support solutions.',
    iconType: 'housing',
  },
  {
    slug: 'uc-bearings',
    ...
    short: 'Insert bearings for housing units.',
    description: 'UC insert bearings (with set-screw or eccentric collar locking) drop into UCP, UCF, UCFC and UCT housings to form a complete mounted unit.',
    iconType: 'uc',
  },
];
...
function buildProducts(): Product[] {
  ...
  type Entry = {
    code: string; bore?: number; od?: number; w?: number;
    section?: string; pitch?: string; length?: number; series?: string;
    image?: string; forceBrand?: string;
  };

  const catEntries: Record<string, Entry[]> = {
    'deep-groove-ball': [
  ...
  CATEGORIES.forEach((cat) => {
    const entries = catEntries[cat.slug] || [];
    entries.forEach((e, i) => {
      ...
      if (e.bore !== undefined && e.od !== undefined) {
        primaryDim = `Ø${e.bore} × Ø${e.od} × ${e.w} mm`;
      } else if (e.length !== undefined && e.section) {
        primaryDim = `${e.section} section · ${e.length} mm pitch length`;
      } else if (e.length !== undefined && e.pitch) {
        primaryDim = `${e.pitch} pitch · ${e.length} mm length`;
      } else if (e.series && e.bore) {
        primaryDim = `${e.series} · Ø${e.bore} mm bore`;
      }
